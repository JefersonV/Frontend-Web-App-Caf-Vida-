      ...
      <Overlay1> 
        ...
        <ContenedorModal>       
            ...
            <label htmlFor="" className='lal1'> Código </label>
              <div className='boddy'>
              <input className='txt1' type="text" placeholder=' Código autogenerado' required /> 
              </div>
            ...
            <label htmlFor="" className='lal2'> Nombre </label>
             ...
             <label htmlFor="" className='lal5'> Dirección </label>
              ...
              <LinkButt>
              <Link to="" className='btn8' onClick={()=> cancelSweet ()}>  Cancelar</Link>
              <Link  to="" className='btn9' onClick={()=> saveSweetalert()}  >  Guardar </Link> 
              </LinkButt>
