...
return(
    ...
    <Overlay>
        <ContenedorModal>
            ...
            <button  className='btn4' onClick={() => cambiarEstadoModal2(!estadoModal2)}> <IoPersonAdd size='2rem' color='darkgoldenrod'/> 
            Agregar Cliente</button> 
            <Link to="/reports" className='btn3'><HiDocumentReport size='2rem' color='darkred'/> 
                Reporte Ventas</Link>
            
            <button   className='btn1' onClick={()=> cambiarEstado(false)}> <AiFillFileText size='2rem' color='rgb(36, 38, 41)'/> 
            Resumen Ventas Realizadas</button> 
                ...
                <div className='metodo'>
                    ...
                    <br />
                    <button  className='dev' > <GiReturnArrow size='2rem' color='rgb(28, 4, 95)'/> Devoluciones</button> 
                ...
                <BodyBottuns>
                    <button  className='btn5' onClick={() => NewSweet() } > <VscNewFile size='2rem' color='rgb(155, 74, 8)' /> Nueva Venta</button>
                  <button  className='btn6' onClick={()=> saveConfirmed()} > <IoIosSave size='2rem' color='darkblue'/> Guardar</button>
                  <button  className='btn7' onClick={() => cancelSweet()} > <FcCancel size='2rem'/> Cancelar</button>
                  <button  className='btn9' > <FcPrint size='2rem'/> Imprimir</button>
                </BodyBottuns>
