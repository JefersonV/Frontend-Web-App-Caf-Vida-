        ...
        <Overlay>
          <ContenedorModal>
            ...
            <Encabezado2>
              <h3>
                {" "}
                <img src="" alt="" /> ¡¡Aroma que te hace soñar, sabor que te
                hace Despertar!!{" "}
              </h3>
            </Encabezado2>
            <BodyDate>
              <label id="lbl2" htmlFor="lbl2">
                {" "}
                DATOS DEL CLIENTE
              </label>
              <label id="lab3" htmlFor="">
                Buscador
              </label>
              ...
              <Link to="" className="btn1" onClick={() => cambiarEstado(false)}>
                {" "}
                <AiFillFileText size="2rem" color="rgb(36, 38, 41)" />
                Listado Ventas Realizadas
              </Link>
              ...
              <BodyBottuns>
                ...
                <Link to="" className="btn9">
                  {" "}
                  <FcPrint size="2rem" /> Cancelar
                </Link>
              </BodyBottuns>
            </BodyDate>
