    ...
    <>
      <div className="TopBar">
        <div className="Contenido">
          <label htmlFor="lab" id="lab">
            {" "}
            Costos de Producción
          </label>

          <Link to="/menu_costos" className="link1">
            {" "}
            Establecer / Modificar Costos
          </Link>
          <button
            className="link2"
            onClick={() => cambiarEstadoCosto(!estadoCosto)}
          >
            {" "}
                  ...
                  <tr key={data.id_costo_produccion}>
                    ...
                    <td>
                      <button
                        ...
                        onClick={() => {
                          cambiarEstadoCosto2(!estadoCosto2);
